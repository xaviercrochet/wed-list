...
(function() {
  ...
  main = function() {
    ...
    return handler.buildMap({
      ...
      var contentString, markers;
      contentString = '<div id="content">' + '<h3>Hotel Les Bruyères</h1>' + '<p>78 route de la barrière</p>' + '<p>6971 Tenneville</p></div>';
...
(function() {
  ...
  main = function() {
    ...
    return $('validated').click(function(event) {
      event.preventDefaut();
      $(this).tab("show");
    });
  };
